/**
 * Created by ascariromopedraza on 03/05/17.
 */
...
(function ($) {
    ...
    function editorHtml (content, options) {
        ...
        html += '<div class="btn-group">';
        html += '<button type="button" data-mdtooltip="tooltip" title="' + options.label.btnJava + '" class="md-btn btn btn-sm btn-default" data-btn="java">Java</button>';
        html += '<button type="button" data-mdtooltip="tooltip" title="' + options.label.btnKotlin + '" class="md-btn btn btn-sm btn-default" data-btn="kotlin">Kotlin</button>';
        html += '<button type="button" data-mdtooltip="tooltip" title="' + options.label.btnGroovy + '" class="md-btn btn btn-sm btn-default" data-btn="groovy">Groovy</button>';
        html += '<button type="button" data-mdtooltip="tooltip" title="' + options.label.btnOtro + '" class="md-btn btn btn-sm btn-default" data-btn="otro">Otro</button>';
        html += '</div>'; // .btn-group
    ...
    var methods = {
        init: function (options) {
            ...
            container.find('.md-btn').click(function () {
                ...
                } else if (btnType === 'java'){
                    insertBeforeText(editor, '\`\`\`java\n\n\`\`\`')
                } else if (btnType === 'kotlin'){
                    insertBeforeText(editor, '\`\`\`kotlin\n\n\`\`\`')
                } else if (btnType === 'groovy'){
                    insertBeforeText(editor, '\`\`\`groovy\n\n\`\`\`')
                } else if (btnType === 'otro'){
                    insertBeforeText(editor, '\`\`\`\n\n\`\`\`')
                } else if (btnType === 'ul') {
                    insertBeforeText(editor, '*');
